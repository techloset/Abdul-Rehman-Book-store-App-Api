    ...
    <>
      <div className="grid md:grid-rows-1 xl:grid-flow-col md:grid-flow-col lg:grid-rows-1 lg:grid-flow-col xl:grid-rows-1 xl:mx-24  mx-auto">
          ...
          {popularBooks ? (
            <>
              {recommendedBooksLoading ? (
                ...
                <div className=" grid grid-rows-1 w-[270px] md:w-full overflow-auto  grid-flow-col md:grid-rows-6 lg:grid-cols-2 lg:w-fit xl:grid-rows-3  mx-1">
                  {popularBooks?.[0] &&
                      ...
                      >
                        <Link to={`/book/${book.id}`}>
                          <img
                            src={book.thumbnail}
                            alt="thumbnail"
                            className="md:w-[160px] w-[92.16px] h-[137px] cursor-pointer md:h-[238px]  rounded-md relative md:left-0 md:bottom-0 bottom-6 left-2  "
                          />
                        </Link>
                        <div className="ml-5 relative bottom-4 md:bottom-0">
              ...
              <button
                ...
                className="w-[280px] mx-6 md:mx-0 my-3 font-hanken h-[48px] md:w-full md:h-[72px] italic cursor-pointer  bg-[#1565D8] rounded-lg text-[#1565D8] bg-opacity-10  text-[16px] font-bold leading-tight tracking-tight "
              >
                {showMore === 6
        ...
        <div className="flex justify-center flex-col items-center md:items-start md:justify-start">
          ...
          <div className=" rounded-md w-[290px] md:w-[360px]  bg-opacity-10 bg-[#B3BAC5] ">
            {bestBooks ? (
              <>
                {bestBooksLoading ? (
                  <Loader />
                ) : (
                  <div className="grid  grid-cols-1 w-[287px] md:w-[311px]     grid-flow-rows md:grid-rows-4 lg:grid-rows-4  xl:grid-rows-4 lg:grid-flow-col mx-1">
                    {bestBooks?.[0] &&
                      bestBooks.map((book) => (
                        <div
                          key={book.title}
                          className="w-[270px] md:w-[287px]  m-4 h-[177.5px] rounded-lg  border-[#ECEEF2]  flex "
                        >
                          <Link to={`/book/${book.id}`}>
                            <img
                              src={book.thumbnail}
                ...
                <button className="w-full h-[72px]  font-hanken   border-t-2 cursor-pointer  text-[#1565D8]  italic text-[16px] font-bold leading-tight tracking-tight">
                  SEE BEST BOOKS
                </button>
              </>
            ) : (
      ...
      <div className="flex justify-center items-center flex-col md:flex-row">
        <div className="flex   justify-center ml-[24px] md:ml-0  my-24">
          <div className="lg:flex">
            <div className="w-[140px] md:w-[265px] p-4 mr-4 h-[240px] rounded-lg border border-[#ECEEF2] flex flex-col justify-center items-center ">
            ...
            <div className="w-[140px] md:w-[265px]  p-4 h-[240px] mr-4 rounded-lg border border-[#ECEEF2] flex flex-col justify-center items-center ">
              <div className="border-2  border-dashed ">
                <div className="bg-sky-100 cursor-pointer w-16 h-16 flex justify-center items-center rounded-full p-1 ">
        ...
        <div className="shadow-lg w-[56px] cursor-pointer  relative md:right-10 md:top-[10px]  flex justify-center items-center   md:bg-white bg-[white] rounded-full md:h-[56px] h-[56px]">
          ...
          <div className=" w-[250px]  mb-2 flex flex-col md:flex-row text-center items-center   md:w-[447px]  md:h-[56px] border-2 border-white rounded-lg mt-4 md:mt-10 mr-10   bg-white">
            <div className="flex mx-[6px]  items-center">
              ...
              <input
                ...
                className="border-none w-[150px] md:w-[245px] pl-2 focus:outline-none"
              />
            </div>
